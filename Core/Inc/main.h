...
#define RELAY3_R_Pin GPIO_PIN_5
#define RELAY3_R_GPIO_Port GPIOC
#define ADC_D11_Pin GPIO_PIN_0
#define ADC_D11_GPIO_Port GPIOB
#define ADC_BUY_Pin GPIO_PIN_2
#define ADC_BUY_GPIO_Port GPIOB
#define ADC_RST_Pin GPIO_PIN_7
#define ADC_RST_GPIO_Port GPIOE
#define ADC_SER_Pin GPIO_PIN_8
#define ADC_SER_GPIO_Port GPIOE
#define ADC_D4_Pin GPIO_PIN_9
#define ADC_D4_GPIO_Port GPIOE
#define ADC_D10_Pin GPIO_PIN_10
#define ADC_D10_GPIO_Port GPIOE
#define ADC_CVT_Pin GPIO_PIN_10
#define ADC_CVT_GPIO_Port GPIOB
...
#define ADC_D12_Pin GPIO_PIN_1
#define ADC_D12_GPIO_Port GPIOD
